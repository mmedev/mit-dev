 ...
 * under the License.
 */
package org.fusesource.examples.cxf.jaxrs.security;
...
public class CustomerService {
    ...
    public Customer getCustomer(@PathParam("id") String id) {
        ...
        producer.requestBody("direct:spin", c);
    ...
    @GET
    @Path("/customers/activemq/{id}/")
    @Produces("application/xml")
    public Customer getCustomerFromActiveMQ(@PathParam("id") String id) {
        System.out.println("----invoking getCustomer, Customer id is: " + id);
        long idNumber = Long.parseLong(id);
       
        Customer c = (Customer) producer.requestBody("direct:getMyAccount", id);
